                      ...
                      <table id="datatable1" class="table display responsive nowrap">
                        <thead>
                          <tr>
                            ...
                            <th class="wd-25p">SubSubcat name bn</th>
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                                <a href="{{ url('admin/sub-sub-category-edit/'.$item->id) }}" class="btn btn-info btn-sm" title="edit data"><i class="fa fa-pencil"></i></a>
                        ...
                        <div class="card-body">
                            <form action="{{ route('sub-subcategory-store') }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="subsubcategory_name_en" value="{{ old('category_name_en') }}" placeholder="Sub-Category name english">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="subsubcategory_name_bn" value="{{ old('category_name_bn') }}" placeholder="Sub-Category name bangla">
